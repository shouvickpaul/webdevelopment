...
<html>
    ...
    <body>
        <?php
            ...
            $user_id = $_SESSION["id"];
            $query = "SELECT p.pid, p.name, p.price FROM items p INNER JOIN users_items up ON up.item_id = p.pid WHERE up.user_id = '$user_id' AND up.status = 'Added to cart'";
        ...
        <div class="container panel-margin">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a href="cart-remove.php?id=<?php echo $row["pid"]; ?>">Remove</a></td>
                </tr>
                <?php
                    }
                ?>
